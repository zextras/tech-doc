...
A new section `Troubleshooting` has been added, collecting various content
...
See :pr:`720` and :pr:`722` for the source code.
...
See :pr:`709` and :pr:`710` for the source code.
...
See :pr:`725` and :pr:`726` for the source code.
