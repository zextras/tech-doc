...
.. note:: This section is dedicated to all Multi-Nodes |carbonio|
   installations. If you plan to install |carbonio| on a
   Single-Server, please refer to section :ref:`scenario-single` for
   the correct hardware requirements.
