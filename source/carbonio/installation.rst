...
.. card::
   ...
   #. Installation of |product| requires to run the command

      .. code:: console

         # apt install carbonio-ce

   #. In order to carry out the initial configuration and start
      |product|, execute
   ...
   #. create a password for the ``zextras@carbonio.local`` user. Log
...
.. commenting out link to community article
   .. seealso:: Our Community portal features a guide that delves more
      into details of the installation process of |ce|. 
