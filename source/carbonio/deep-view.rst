...
.. not (yet?) needed on Carbonio
   ...
   have a look at the administration interface, for example to cheack out
...
* `Carbonio API <../../apidoc/carbonio/index.html>`_ is used to interact
  programmatically with |product|\ 's core functions

* `Carbonio Files blob <../../apidoc/files_blob/index.html>`_ helps in
  the management of the saved files
