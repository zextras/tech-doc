...
Whether a network is considered trusted or untrusted depends on how the system has been set. 
...
* **If you have NOT configured 2FA:** Depending on your organization's security policy, you will be redirected to setup wizard.
...
* You must complete the setup before the grace period expires. If the period ends and you have not configured 2FA, you will be unable to sign in from an untrusted network.
