...
1. **Scan the QR Code:** Open your preferred authenticator app and either scan the QR code displayed on your screen or, if you can’t scan the QR code, enter the secret code directly into the application.
