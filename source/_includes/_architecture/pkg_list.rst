...
.. dropdown:: **Mesh & Directory**
   ...
   - **carbonio-user-management**: `carbonio-user-management` *(1.1.1-1)*
...
.. dropdown:: **MTA**
   ...
   - **carbonio-mta**: `carbonio-mta` *(4.2.5-1)*
...
.. dropdown:: **Files**
   ...
   - **carbonio-files**: `carbonio-files` *(2.1.2-1)*

.. dropdown:: **Docs & Editor**

   - **carbonio-docs-editor**: `carbonio-docs-editor` *(25.04.8-5)*
   - **carbonio-docs-connector**: `carbonio-docs-connector` *(1.1.1-1)*

.. dropdown:: **Preview**

   - **carbonio-preview**: `carbonio-preview` *(1.0.2-1)*

.. dropdown:: **Tasks**

   - **carbonio-tasks**: `carbonio-tasks` *(1.1.0-1)*

.. dropdown:: **Chats**

   - **carbonio-message-dispatcher**: `carbonio-message-dispatcher` *(1.2.6-1)*
   - **carbonio-ws-collaboration**: `carbonio-ws-collaboration` *(1.11.0-1)*
   - **carbonio-push-connector**: `carbonio-push-connector` *(0.2.2-1)*
   - **carbonio-notification-push**: `carbonio-notification-push` *(0.4.1-1)*

.. dropdown:: **Video Server & Video Recording**

   - **carbonio-videoserver-advanced**: `carbonio-videoserver-advanced` *(2.1.3-1)*
   - **carbonio-videorecorder**: `carbonio-videorecorder` *(2.2.1-1)*

.. dropdown:: **Monitoring**

   - **carbonio-prometheus**: `carbonio-prometheus` *(3.11.3-1)*
   - **carbonio-prometheus-alertmanager**: `carbonio-prometheus-alertmanager` *(0.32.1-1)*
