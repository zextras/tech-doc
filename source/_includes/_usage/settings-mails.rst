...
.. index:: recover message, undelete message, message; recover, message; undelete

.. card:: Recover Messages
   :class-header: sd-font-weight-bold irisfont
   ...
   the :bdg-primary-line:`RECOVER SELECTED E-MAILS` button. In a few
   ...
   18_23_53`` (the format of the folder name will always include the
   timestamp of the operation and be of the
   form ``undelete <DD_MM_YYYY> <HH_MM_SS>``).

   .. note:: This feature must explicitly be enabled by an Administrator.
