...
change the password can be found in Section :ref:`change-pwd`.

After you change the password, point a :ref:`supported browser
<browser_compatibility>` to the |product| hostname and port
...
.. note:: It is strongly suggested to install an SSL certificate.
   Please refer to Section :ref:`install-SSL-cert` (CLI) or :ref:`ap-vhost` |adminui| for
...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: Web Client
      ...
      to access to the e-mail account and is available at https://mail.example.com/.
      In the `User Guide <https://docs.zextras.com/user-guides/carbonio/en/html>`_ you
