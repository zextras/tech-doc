...
.. grid:: 1 2 2 3
   ...
   .. grid-item-card:: |wsc|
      ...
      .. grid:: 1 1 1 1
         ...
         .. grid-item-card:: Chats
            :columns: 6 6 6 6
            :class-title: sd-font-weight-bold sd-fs-4
            :link: ../../../apidoc/carbonio-ws-collaboration-ce/chats-api.html
         ...
         .. grid-item-card:: Meeting
            :columns: 6 6 6 6
            :class-title: sd-font-weight-bold sd-fs-4
            :link: ../../../apidoc/carbonio-ws-collaboration-ce/meeting-api.html
   ...
   .. grid-item-card:: Preview
      :columns: 12 12 12 12
      :class-title: sd-font-weight-bold sd-fs-4 sd-text-center
      :link: ../../../apidoc/carbonio-preview-ce/rest-api.html
