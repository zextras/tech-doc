pipeline {
    ...
    stages {
      stage('Building Sphinx using doker') {
	    ...
	    sh 'docker run -v $(pwd):/docs sphinx_builder python -m sphinx /tmp/workspace/d_zextras_ztd-sphinx_pre_release/docs/source/suite /tmp/workspace/d_zextras_ztd-sphinx_pre_release/docs/build/'
